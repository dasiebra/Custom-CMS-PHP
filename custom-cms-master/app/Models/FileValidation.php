...
class FileValidation implements ValidationInterface {
    ...
    //Prüft ob die angegeben Regeln wie rules, maxsize, type usw richtig sind und gibt entsprechende Fehlermeldung aus.
    ...
    private function type($field, $satisfier): ?string
    {
        ...
        if (!in_array($extension, $allowedExtensions)) {
            return "Das {$field} field must be of type {$satisfier}";
        }
